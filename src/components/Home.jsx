                ...
                <div className="flex justify-between pt-10">
                        ...
                        <div className="card-content flex gap-10 pl-4 pr-4  items-center justify-around text-xs">
                            <div className="w-[500px]">
                                <div className="flex">
                                    ...
                                    <img src="/src/assets/waving_hand.gif" alt="" />
                                </div>
                            ...
                            <div className="">
                                <div className="flex gap-1 pb-5">
                                    ...
                                    <img className="h-[100px] w-[100px]" src="/src/assets/Web-develpoment.gif" alt="" />
                                </div>
                                {/* <div  className="flex">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <img className="h-[80px] w-[90px]" src="/src/assets/tech-images.png" alt="" />
                                </div>
                    ...
                    <div className="flex space-x-4 gap-8  h-[250px]">
                        <div className="card-wrapper h-[250px] rounded-xl">
                            <img className="card-content h-[250px] w-[270px] rounded-xl" src="/src/assets/IMG-preview.png" alt="" />
                        </div>   
                    </div> 
                </div>
                <div className="flex flex-row gap-3 justify-between">
                    <div className="flex space-x-7 items-center h-[150px]">
                            ...
                            >
                                ...
                                <p>Resume</p>
                                <img className="bg-emerald-50 h-[25px]" src="/src/assets/down.png" alt="" /> 
                            </button>
                            </a>
                            <a href="#project">
                    ...
                    <div className="card-wrapper h-[150px] w-[600px]">
                        <div className="card-content flex items-center justify-between text-xs">
                            <img className="h-[150px] w-[200px]" src="/src/assets/location.gif" alt="" />
                            ...
                            <div className="w-[400px] ml-5">
                                ...
                                <div className="flex flex-row gap-1">
                                    ...
                                    <img className="h-[80px] w-[80px] ml-5 rounded-full" src="/src/assets/bangladesh_flag_lottie_json_animation_800.gif" alt="" />
                                </div>
                            </div>
